...
sed -i 's/$(VERSION_DIST_SANITIZED)/$(shell TZ=UTC-8 date +%Y%m%d)-liuhonglu/g' include/image.mk
sed -i 's/invalid/# invalid/g' package/network/services/samba36/files/smb.conf.template
echo "DISTRIB_REVISION='by$(TZ=UTC-8 date +%Y.%m.%d) liuhoglu'" > ./package/base-files/files/etc/openwrt_release1
...
git clone https://github.com/yjiawqgj/luci-app-netmap/trunk/ package/luci-app-netmap
